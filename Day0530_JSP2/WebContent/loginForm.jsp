...
<script src="<%=path %>/js/loginJs.js"></script>
<style type = "text/css">
	#error{
		font-size : 11px;
		color : red;
		...
		<div id="content">
			<form action="login" name="frm1"  onSubmit = "return false" method="POST">
				...
				<fieldset>
					...
					<p>
						<label>비밀번호<input type="password" id = "pwd" name="pwd" onkeydown = "down(event)"></label>
					</p>
					<p id = "error">
						<%=msg%>
					</p>
					<p>
						...
						<input type="button" value = "회원가입" onclick = "location.href = 'newjoinForm'" >
					</p>
				</fieldset>
			</form>
		</div>
